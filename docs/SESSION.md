...
Last updated: 2026-09-05 (branch `scenario`: s00 v0.2.0 NPC quests + captain trial)
...
- Current: **s00** v0.2.0 — Надзор, NPC, испытание капитана. `docs/scenario/`. Changelog: `docs/scenario/CHANGELOG.md`.
